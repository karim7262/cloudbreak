...
public class TelemetryCommonConfigService {
    ...
    public TelemetryCommonConfigView createTelemetryCommonConfigs(Telemetry telemetry, List<VmLog> logs,
        ...
        if (telemetryUpgradeConfiguration.isEnabled()) {
            builder.withDesiredCdpTelemetryVersion(telemetryUpgradeConfiguration.getDesiredCdpTelemetryVersion())
                    .withDesiredCdpLoggingAgentVersion(telemetryUpgradeConfiguration.getDesiredCdpLoggingAgentVersion());
        }
        return builder
